...
1. [Inscrivez vous](https://www.ferank.fr/inscription/) si vous n'utilisez pas encore FERank
2. Uploadez le dossier `ferank` dans `/wp-content/plugins/`
3. Activez le plugin depuis le menu `Extensions` de Wordpress

== Screenshots ==

1. Bloc d'annonce responsive design
